...
set_property PACKAGE_PIN AB8      [get_ports "i_pcie_refclkn"]       ;# Bank 227 - MGTREFCLK0N_227
set_property PACKAGE_PIN AB9      [get_ports "i_pcie_refclkp"]       ;# Bank 227 - MGTREFCLK0P_227
...
create_clock -period 10.000 -name pcie_ref_clk0  [get_ports "i_pcie_refclkp"]
set_property CLOCK_DEDICATED_ROUTE ANY_CMT_COLUMN [get_nets pcie_refclk_gt]
...
#
set_property PACKAGE_PIN AW27     [get_ports "i_pcie_rstn"]          ;# Bank  65 VCCO - VCC1V8   - IO_T3U_N12_PERSTN0_65
set_property IOSTANDARD  LVCMOS18 [get_ports "i_pcie_rstn"]          ;# Bank  65 VCCO - VCC1V8   - IO_T3U_N12_PERSTN0_65
...
#
set_property PACKAGE_PIN E18      [get_ports "o_led0"] ;# Bank  68 VCCO - VCC1V8   - IO_L14P_T2L_N2_GC_68
set_property IOSTANDARD  LVCMOS18 [get_ports "o_led0"] ;# Bank  68 VCCO - VCC1V8   - IO_L14P_T2L_N2_GC_68
