...
# Set xvlog options
xvlog_opts="--incr --relax  -L uvm -L xdma_v4_1_20"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto  -L gtwizard_ultrascale_v1_7_14 -L xil_defaultlib -L blk_mem_gen_v8_4_5 -L xdma_v4_1_20 -L uvm -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot xdma_0 xil_defaultlib.xdma_0 xil_defaultlib.glbl -log elaborate.log
}
