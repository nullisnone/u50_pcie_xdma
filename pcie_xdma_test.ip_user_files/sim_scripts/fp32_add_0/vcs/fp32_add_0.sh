...
#
# Generated by Vivado on Tue Apr 07 19:23:10 HKT 2026
# SW Build 3671981 on Fri Oct 14 04:59:54 MDT 2022
#
# Tool Version Limit: 2022.10 
#
# usage: fp32_add_0.sh [-help]
# usage: fp32_add_0.sh [-lib_map_path]
# usage: fp32_add_0.sh [-noclean_files]
# usage: fp32_add_0.sh [-reset_run]
#
...
# executing this script. Please type 'fp32_add_0.sh -help' for more information.
#
...
# Script info
echo -e "fp32_add_0.sh - Script generated by export_simulation (Vivado v2022.2 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"/opt/Xilinx/Vivado/2022.2/data/xilinx_vip/include" \
    "$ref_dir/../../../../pcie_xdma_test.gen/sources_1/ip/fp32_add_0/sim/fp32_add_0.v" \
  2>&1 | tee -a vlogan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fp32_add_0 xil_defaultlib.glbl -o fp32_add_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fp32_add_0_simv $vcs_sim_opts -do simulate.do
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./fp32_add_0.sh -help\" for more information)\n"
        exit 1
      fi
...
reset_run()
{
  files_to_remove=(ucli.key fp32_add_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc fp32_add_0_simv.daidir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./fp32_add_0.sh -help\" for more information)\n"
    exit 1
  fi
